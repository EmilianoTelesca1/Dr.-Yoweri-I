...
while($registroEmpleados = $resEmp->fetch_array(MYSQLI_BOTH)){
                  ...
                  {
                    echo '<tr>
                        <td>' . $registroStock['id'] . '</td>
                        <td>' . $registroStock['fecha'] . '</td>
                        <td>' . $registroStock['tipo'] . '</td>
...
?>
                ...
                <a href="actualizar.php" class="waves-effect waves-light btn orange darken-3" id="actualizar">MODIFICAR</a>
